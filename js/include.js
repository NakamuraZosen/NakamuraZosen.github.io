...
<nav id="header__nav">
  <ul class="header__list">
    ...
    <li class="header__item"><a href="https://zosen.nnz-design.com/Statistics/createrList/index.html" class="header__item-link"><span>中村センサス</span><small>census</small></a></li>
...
footer.insertAdjacentHTML('afterbegin', `
    <div class="footer-in wrap">
      ...
      <div class="footer__links">
        <a class="footer__link" href="https://www.youtube.com/channel/UCzB8_PC3Siup1Zai8EfJC2g" aria-label="youtube" target="_blank" rel="noopener noreferrer">
        ...
        <a class="footer__link" href="https://twitter.com/NHI_nakamura" aria-label="x" target="_blank" rel="noopener noreferrer">
        ...
        <a class="footer__link" href="https://blog.nnz-design.com/" aria-label="blog" target="_blank" rel="noopener noreferrer">
          <img src="https://zosen.nnz-design.com/img/icon-blog.webp" alt="ブログのアイコン">
          <span>公式 Blog</span>
        </a>
        <div class="footer__link footer__inactive">
